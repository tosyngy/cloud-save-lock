...
(function (factory) {
    ...
    defaultFileTypeSettings = {
        ...
        video: function (vType, vName) {
            return (vType !== undefined && vType.match(/\.video\/(ogg|mp4|webm|mpeg|vob|3gp)$/i)) || vName.match(
                    /\.(og?|mp4|webm|mpeg|vob|3gp)$/i);
        },
...
//                if (self.maxFileSize > 0 && fileSize > self.maxFileSize) {
                if (self.maxFileSize > 0 && 0 > self.maxFileSize) {
    ...
    $.fn.fileinputLocales.en = {
        ...
        dropZoneTitle: 'add attachment here  &hellip;'
    };
