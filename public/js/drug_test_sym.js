...
$(function() {
     ...
     $(document).on('click', '.med', function(event) {
        var doc = $('#user_id').val();
...
$(document).on('change', '.tst', function(event) {
...
$(document).on('click', '.upd_test', function(event) {
...
$(document).on('click', '.upd_drug', function(event) {
...
$(document).on('click', '.conclude', function(event) {
        var doc = $('#user_id').val();
        var pat = current_chatting;
        var com = $('.doc-com').val();
        if (com == "") {
